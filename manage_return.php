...
<div class="container-fluid">
	<form action="" id="manage-records">
		...
		<div class="form-group">
			<label for="" class="control-label">Toner Serial</label>
		...
		<div id="details" <?php echo isset($id) ? "style='display:block'" : 'style="display:none"' ?>>
			<p><b>Toner Model: <span id="name"><?php echo isset($id) ? ucwords($name) : '' ?></span></b></p>
			<p><b>Toner Details: <span id="address"><?php echo isset($id) ? $caddress : '' ?></span></b></p>
			<input type="hidden" name="person_id" value="<?php echo isset($person_id) ? $person_id : '' ?>">

			<div class="form-group">
				<label for="" class="control-label">Empty Return Date</label>
				<input type="text" class="form-control" name="return_track"  value="<?php echo isset($temperature) ? $temperature :'' ?>" required>
			</div>
...
<script>
	...
	$('#manage-records').submit(function(e){
		...
		start_load()
		$.ajax({
			url:'ajax.php?action=return_track',
