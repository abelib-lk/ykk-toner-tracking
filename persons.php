		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa fa-plus"></i> Add Toner</button>
...
<script>
	...
	$('#new_person').click(function(){
		uni_modal("New Toner","manage_person.php","mid-large")
	})
	
	$('.edit_person').click(function(){
		uni_modal("Edit Toner","manage_person.php?id="+$(this).attr('data-id'),"mid-large")
		
	})
	$('.view_person').click(function(){
		uni_modal("Toner Details","view_person.php?id="+$(this).attr('data-id'),"large")
		
	})
	$('.delete_person').click(function(){
		_conf("Are you sure to delete this toner?","delete_person",[$(this).attr('data-id')])
	})
