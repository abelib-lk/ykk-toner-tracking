...
$ids = implode(",",$ids);
$qry = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name, concat(address,', ',street,', ',baranggay,', ',city,', ',state,', ',zip_code) as caddress FROM persons where id in ($ids) ");
...
<style type="text/css">
   ...
   font-weight: 700;
	...
	<div class="" id="bcode-field">
		<img id="bcode" src="data:image/png;base64,<?php echo base64_encode($generator->getBarcode($tracking_id, "C39")) ?>">
