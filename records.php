			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Toners Monitoring List</b>
						<span class="">

							<button class="btn btn-primary btn-block btn-sm col-sm-2 float-right" type="button" id="new_records">
								<i class="fa fa-plus"></i> New</button>

							<button class="btn btn-info btn-block btn-sm col-sm-2 float-right mr-2 mt-0" type="button" id="return_date">
								<i class="fa fa-minus"></i>Empty Return</button>
						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<thead>
								<tr>
									...
									<th class="">Toner Model</th>
									<th class="">Toner Details</th>
									<th class="">Department</th>
									<th class="">Issued Date</th>
									<th class="">Empty Re-Date</th>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td class="text-right">
											<p> <b><?php echo $row['return_date'] ?></b></p>
										</td>
...
<script>
	...
	$('#return_date').click(function() {
		uni_modal("Return Empty", "manage_return.php")
	})
	...
	$('.delete_records').click(function() {
		_conf("Are you sure to delete this Toner?", "delete_records", [$(this).attr('data-id')])
	})
